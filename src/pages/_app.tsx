	...
	return (
		<StrictMode>
			...
			>
				...
				<AnimatePresence>
					{mobileMenuOpen && (
						<motion.div
							...
							exit={{ opacity: 0 }}
							className="fixed inset-0 z-40 py-24 px-8 space-y-2 bg-white dark:bg-gray-900 sm:hidden"
						>
				...
				<div className="overflow-hidden sticky top-0 z-50 h-32 transition-all sm:hidden">
					<div
						className={`${
